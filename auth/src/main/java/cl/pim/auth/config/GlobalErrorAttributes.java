...
import cl.pim.auth.shared.exceptions.GlobalException;
...
public class GlobalErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(ServerRequest request, ErrorAttributeOptions options) {
        Map<String, Object> map = super.getErrorAttributes(request, options.including(ErrorAttributeOptions.Include.STACK_TRACE));
        if (getError(request) instanceof GlobalException ex) {
            return ex.getProperties();

        } else if (getError(request) instanceof ResponseStatusException ex) {
